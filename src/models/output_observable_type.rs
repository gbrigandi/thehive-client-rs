...
pub struct OutputObservableType {
    #[serde(rename = "_id")]
    pub _id: String,
    #[serde(rename = "_type")]
    pub _type: String,
...
impl OutputObservableType {
    pub fn new(_id: String, _type: String, _created_by: String, _created_at: i64, name: String, is_attachment: bool) -> OutputObservableType {
